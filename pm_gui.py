...
layout = [
    ...
    [sg.InputText(key="user_start", size=(5, 1.5), enable_events=True, default_text="Start"),],
    [sg.InputText(key="user_end", size=(5, 1.5), default_text="End")],
    [sg.Button("Submit")]
]
